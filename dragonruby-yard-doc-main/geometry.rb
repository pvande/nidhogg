module GTK
  module Geometry
    class << self
      ...
      #
      # @option opts [Float] :percentage_x percentage to change the width (default value of 1.0)
      # @option opts [Float] :percentage_y percentage to change the height (default value of 1.0)
      # @option opts [Float] :anchor_x anchor repositioning of x (default value of 0.0)
      # @option opts [Float] :anchor_y anchor repositioning of y (default value of 0.0)
      # @return [Hash] a new rectangle with a scaled size.
      ...
      # @return [Hash,nil] returns point of intersection if the line segments intersect, nil if not
      ...
      # @param line_1 [Object] a line (a Hash with x, y, x2, and y2 keys, or an Object that responds to x, y, x2, and y2).
      # @param line_2 [Object] a line (a Hash with x, y, x2, and y2 keys, or an Object that responds to x, y, x2, and y2).
      # @return [Hash,nil] returns point of intersection if the ray(infinite line) intersect, nil if not
      ...
      #
      # @param vec [Object] a Hash with x and y keys (or an Object that responds to x and y).
      # @return [Hash] return a Hash with x and y keys that represents the vector normalized.
      def vec2_normalize vec; end
      ...
      def rect_navigate rect, rects, left_right, up_down, directional_vector, wrap_x, wrap_y, using; end
      ...
      #
      # @param rects1 [Object] The first parameter can be an array or a single Hash (or an object that responds to x, y, w, h).
      # @param rects2 [Object] The second parameter can be an array or a single Hash (or an object that responds to x, y, w, h). The second parameter should be the larger of the two sets of rectangles.
      ...
      def each_intersect_rect rects1, rects2, tolerance = 0.1, using = nil; end
    end
  end
end
